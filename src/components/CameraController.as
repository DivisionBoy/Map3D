package components {
	...
	public class CameraController {
		 ...
		 */
		public function CameraController(eventSource:InteractiveObject, object:Object3D, speed:Number, speedMultiplier:Number = 3, mouseSensitivity:Number = 1) {
		 ...
		 */
		public function setCooZ(zCoo:int):void {
			TweenMax.to(_object, 1, { z:zCoo/*, ease: Elastic.easeIn*/});
			//_object.z = zCoo
			
		}
		public function getCooX():Number {
			return this.object.x
		}
		public function getCooY():Number {
			return this.object.y
		}
		public function getCooZ():Number {
			return this.object.z
		}
		public function standardViewModeEnable():void{
			standardMode = true;
			
		}
		public function standardViewModeDisable():void{
			standardMode = false;
			
		}
		public function set rotationObject(rotX:Number):void {
			desiredRotation.x = rotX;
			
		}
		public function setObjectCoo(initX:Number, initY:Number):void {
			this.object.x = initX
			this.object.y = initY
		...
		public function update():void {
			...
			if (mouseLook) {
				...
				if(!standardMode)v.x -= dy*Math.PI/180*mouseSensitivity;
		...
		public function setObjectPosXYZ(x:Number, y:Number, z:Number):void {
			if (_object != null) {
				...
				_object.y = y;
				//_object.z = z;
				TweenMax.to(desiredCoords, 0.5, { z:z/*, ease: Elastic.easeIn*/});
				idleTime = 0;
				//trace(z)
				updateObjectTransform();
			}
		}
		public function setObjectPosXYZDoubleClick(x:Number, y:Number, z:Number):void {
			if (_object != null) {
				var v:Vector3D = objectTransform[0];
				v.x = x;
				v.y = y;
				...
				desiredCoords.y = y;
				//_object.z = z;
				TweenMax.to(desiredCoords, 0.5, { x:x,y:y,z:z/*, ease: Elastic.easeIn*/});
				idleTime = 0;
				//trace(z)
				updateObjectTransform();
			}
		...
		public function lookAtXYZ(x:Number, y:Number, z:Number):void {
			...
			v.y = 0;
			v.z = 0;
			//TweenMax.to(_object, 0.5, { shortRotation: { rotationX:v.x, rotationY:v.y, rotationZ:v.z }} );
			TweenMax.to(desiredRotation, 0.5, { x: -2.8, y: v.y/*, z:v.z/*, ease: Elastic.easeIn*/});
			//_object.rotationX = v.x;
			//_object.rotationY = v.y;
			//_object.rotationZ = v.z;
